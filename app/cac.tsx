...
export default function CACScreen() {
  ...
  const loadBanks = async () => {
    try {
      setLoading(true);
      const q = query(collection(db, 'companies'), where('type', '==', 'cac'));
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.titleContainer}>
        <View style={styles.cacBox}>
          <Text style={styles.cacText}>CAC</Text>
        </View>
        <Text style={styles.subtitle}>Consumer and Commercial Credit</Text>
      </View>
        ...
        >
          {banks.length === 0 ? (
            <View style={styles.emptyContainer}>
              ...
              <Text style={styles.emptyText}>Belum ada data bank</Text>
            </View>
          ) : (
            banks.map((bank) => (
              <TouchableOpacity
              ...
              >
                ...
                <View style={styles.productBadge}>
                  <Text style={styles.productText}>{bank.produk}</Text>
                </View>
                ...
                <View style={styles.infoGrid}>
                  ...
                  <View style={[styles.infoItem, styles.infoItemFull]}>
                    ...
                    <Text style={[styles.infoValue, styles.sisaValue]}>
                      {formatNumber(bank.sisaHakSubrogasi)}
                    </Text>
                  </View>
                </View>
              </TouchableOpacity>
